        ...
        <CardContent className="space-y-6">
          {response.error && (
            <div className="relative">
              <div className="h-auto p-4 bg-gradient-to-br from-destructive/5 to-destructive/10 rounded-lg border border-destructive/20 flex items-center justify-center">
                <div className="text-center space-y-3">
                  <div className="p-2 bg-destructive/10 rounded-lg w-fit mx-auto">
                    <AlertTriangle className="h-6 w-6 text-destructive" />
                  </div>
                  <div className="space-y-1">
                    <h3 className="font-medium text-destructive text-sm">Audio Generation Failed</h3>
